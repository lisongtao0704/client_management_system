  ...
  <div class="page">
    <div onselectstart="return false">
      ...
      <ul ref="home">
        ...
        <li>
          <router-link to="/console/home/onLineMonitoring"
            >在线监控</router-link
          >
        </li>
        <li><router-link to="/console/home/myCall">我的通话</router-link></li>
        <li>
          <router-link to="/console/home/callMonitoring">呼叫监控</router-link>
        </li>
        <li>
          <router-link to="/console/home/serviceMonitor"
            >呼叫客服监听</router-link
          >
        </li>
      </ul>
...
export default {
  ...
  if(window.location.pathname.startsWith("/console/home")){
    document.getElementsByClassName("left_icon")[0].style.background="var(--active)"
  }
  }
};
</script>